...
def main():
    ...
    optimizer = RLModelOptimizerGym(gym_env, PPO.load("./data/ppo_training/obj_1/medium_scenario/otimization/1M5k-timesteps_50-max-trials/24000000_time_steps_best_params/best_model/best_model.zip"))
    optimizer.run_simulations(num_runs, RESULTS_DIR + "ppo_agent_trained_24000000_best_params/", seed=SEED)

    # optimizer = RLModelOptimizerGym(gym_env, PPO.load("./data/ppo_training/obj_1/medium_scenario/400000_time_steps_best_params/best_model/best_model.zip"))
    # optimizer.run_simulations(num_runs, RESULTS_DIR + "ppo_agent_trained_400000_best_params/", seed=SEED)
