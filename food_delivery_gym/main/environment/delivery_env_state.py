    ...
    def print_state(self, options=None):
        ...
        if options.get("drivers", False):
            ...
            for _, driver in enumerate(self.drivers):
                print(f"Motorista {driver.driver_id}: Coordenadas = {driver.coordinate}, Última coordenada futura = {driver.last_future_coordinate}, Status = {driver.status}, Quantidade de pedidos na lista = {len(driver.orders_list)}")
